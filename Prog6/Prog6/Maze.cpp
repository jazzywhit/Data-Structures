...
void Maze::SetSpeed()
{
   ...
   const unsigned XPrompt = 33;  // Screen column for speed prompt
   const unsigned YPrompt = 0;   // Screen row for speed prompt
   ...
   do
      ...
      clreol();
      cout << "Speed [min=" << MinSpeed << ", default=" << DefSpeed << " ctrl-C quits" << "]: ";
